...
import CharacterStore from '../stores/CharacterStore.jsx';
import CharacterActions from '../actions/CharacterActions.jsx'
...
class Character extends React.Component {
    ...
    componentDidMount() {
        ...
        CharacterStore.listen(this.onChange); // listen to the store
