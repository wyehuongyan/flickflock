...
class Footer extends React.Component {
    ...
    componentWillMount() {
        // before rendering: called once when loaded (client & server)
    }

    componentDidMount() {
        // after rendering: called once when loaded (client only)
        FooterStore.listen(this.onChange); // listen to the store
        FooterActions.getTopCharacters();
    }

    componentWillUnmount() {
        // called immediately before component is unmounted from DOM
        FooterStore.unlisten(this.onChange);
    }

    onChange(state) {
        this.setState(state); // setState always rerenders the component
    }
